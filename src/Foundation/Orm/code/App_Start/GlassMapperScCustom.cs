...
using MarketingVillage.Foundation.Orm.Extensions;
...
namespace MarketingVillage.Foundation.Orm.App_Start
{
    public static class GlassMapperScCustom
    {
        ...
        public static void AddMaps(IConfigFactory<IGlassMap> mapsConfigFactory)
        {
            ...
            foreach (string dll in Directory.GetFiles(binPath, "Edy*.dll", SearchOption.AllDirectories))
            {
                try
                {
